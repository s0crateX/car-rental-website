...
interface UserDetailsProps {
  user: User;
  onClose: () => void;
  onVerification: (documentName: string, status: 'verified' | 'rejected', reason?: string) => void;
  className?: string;
}
        ...
        <Card>
          <CardHeader>
            <div className="flex items-center">
              <Button variant="ghost" className="mr-2 md:hidden" onClick={onClose}>
                        ...
                        <AlertDialog>
                          ...
                          <AlertDialogContent>
                            ...
                            <AlertDialogFooter>
                              ...
                              <AlertDialogAction onClick={() => onVerification(key, 'verified')}>Continue</AlertDialogAction>
                            </AlertDialogFooter>
                          </AlertDialogContent>
                        </AlertDialog>
                        <AlertDialog>
                          ...
                          <AlertDialogContent>
                            ...
                            <AlertDialogFooter>
                              <AlertDialogCancel>Cancel</AlertDialogCancel>
                              <AlertDialogAction onClick={() => handleReject(key)}>
                                Confirm Rejection
                              </AlertDialogAction>
                            </AlertDialogFooter>
                          </AlertDialogContent>
